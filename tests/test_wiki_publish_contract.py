...
def test_github_wiki_publish_script_contract() -> None:
    ...
    assert "ICP Radar catalog" in script
    ...
    assert "![ICP Radar catalog](../qa/screenshots/visual-smoke/icp-radar-1366x768.png)" in user_guide
...
def test_github_wiki_dry_run_has_curated_pages(tmp_path: Path) -> None:
    ...
    assert "![ICP Radar catalog](assets/screenshots/visual-smoke/icp-radar-1366x768.png)" in user_guide
    ...
    assert "## ICP Radar catalog" in qa
