...
- `2026-07-19-product-semantic-roles-and-access-playbook.md` - Persist product, semantic buying roles and access rules as independently versioned sales configuration before Power Web Discovery.
