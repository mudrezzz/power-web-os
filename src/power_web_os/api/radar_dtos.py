...
class RadarRunDossierResponse(BaseModel):
    ...
    source_capability_strategy_summary: dict[str, Any] = Field(default_factory=dict)
    ...
    external_call_budget_settings: dict[str, Any] = Field(default_factory=dict)
    ...
    expansion_target_queue: list[dict[str, Any]] = Field(default_factory=list)
    ...
    semantic_task_budget_counters: dict[str, int] = Field(default_factory=dict)
