...
from power_web_os.application.radar.configuration.runtime_model_profiles import runtime_model_profiles_config
from power_web_os.application.radar.configuration.runtime_settings import effective_runtime_values
...
CRITICAL_FINGERPRINT_PATHS = (
    ...
    ("radar", "max_openrouter_planner_calls_per_run"),
    ("radar", "max_openrouter_web_task_calls_per_run"),
    ("radar", "max_openrouter_server_tool_web_searches_per_run"),
    ("radar", "max_dadata_lookups_per_run"),
    ("radar", "max_source_verification_requests_per_run"),
    ("radar", "max_provider_retries_per_task"),
    ("radar", "openrouter_web_max_results_per_call"),
    ("radar", "openrouter_web_max_total_results_per_call"),
    ...
    *,
    ...
    config = {
        ...
        "radar": {
            ...
            "max_openrouter_planner_calls_per_run": _optional_non_negative_int_value(value("POWER_WEB_OS_RADAR_MAX_OPENROUTER_PLANNER_CALLS_PER_RUN", "")),
            "max_openrouter_web_task_calls_per_run": _optional_non_negative_int_value(value("POWER_WEB_OS_RADAR_MAX_OPENROUTER_WEB_TASK_CALLS_PER_RUN", "")),
            "max_openrouter_server_tool_web_searches_per_run": _optional_non_negative_int_value(value("POWER_WEB_OS_RADAR_MAX_OPENROUTER_SERVER_TOOL_WEB_SEARCHES_PER_RUN", "")),
            ...
            "openrouter_web_max_results_per_call": _optional_non_negative_int_value(value("POWER_WEB_OS_RADAR_OPENROUTER_WEB_MAX_RESULTS_PER_CALL", "")),
            "openrouter_web_max_total_results_per_call": _optional_non_negative_int_value(value("POWER_WEB_OS_RADAR_OPENROUTER_WEB_MAX_TOTAL_RESULTS_PER_CALL", "")),
...
def runtime_config_api_overrides(settings: Any) -> dict[str, Any]:
    return {
        ...
        "POWER_WEB_OS_RADAR_MAX_OPENROUTER_PLANNER_CALLS_PER_RUN": getattr(settings, "radar_max_openrouter_planner_calls_per_run", None),
        "POWER_WEB_OS_RADAR_MAX_OPENROUTER_WEB_TASK_CALLS_PER_RUN": getattr(settings, "radar_max_openrouter_web_task_calls_per_run", None),
        "POWER_WEB_OS_RADAR_MAX_OPENROUTER_SERVER_TOOL_WEB_SEARCHES_PER_RUN": getattr(settings, "radar_max_openrouter_server_tool_web_searches_per_run", None),
        ...
        "POWER_WEB_OS_RADAR_OPENROUTER_WEB_MAX_RESULTS_PER_CALL": getattr(settings, "radar_openrouter_web_max_results_per_call", None),
        "POWER_WEB_OS_RADAR_OPENROUTER_WEB_MAX_TOTAL_RESULTS_PER_CALL": getattr(settings, "radar_openrouter_web_max_total_results_per_call", None),
