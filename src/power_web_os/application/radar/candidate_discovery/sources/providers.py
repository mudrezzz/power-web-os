...
from power_web_os.application.radar.candidate_discovery.sources.registry_observation_helpers import (
...
from power_web_os.application.radar.candidate_discovery.sources.registry_helpers import (
