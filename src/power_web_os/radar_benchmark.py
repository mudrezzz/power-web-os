...
BENCHMARK_PROFILES: dict[str, dict[str, Any]] = {
    "benchmark_smoke": {
        ...
        "max_openrouter_calls_per_run": 20,
        ...
        "max_openrouter_server_tool_web_searches_per_run": 60,
        "max_dadata_lookups_per_run": 4,
        "max_source_verification_requests_per_run": 40,
...
def benchmark_result_summary(
    *,
    ...
    return {
        ...
        "work_admission_reserved_capacity": _dict(dossier.get("work_admission_reserved_capacity")),
        ...
        "work_scheduler_plan": _dict(dossier.get("work_scheduler_plan")),
        "work_scheduler_ledger": _dict(dossier.get("work_scheduler_ledger")),
        "work_lane_summary": _dict(dossier.get("work_lane_summary")),
        "work_guarantee_failures": _list(dossier.get("work_guarantee_failures")),
        "work_admission_decision_count": len(_list(dossier.get("work_admission_decisions"))),
        "rejected_work_item_count": len(_list(dossier.get("rejected_work_items"))),
        ...
        "search_expansion_selection_summary": _dict(dossier.get("search_expansion_selection_summary")),
